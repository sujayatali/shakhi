<?php
namespace App\Http\Controllers\webApps\bcAdmin;
...
class bcUserMemberController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.bcAdmin.userMember.bc-admin-usermember-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.bcAdmin.userMember.bc-admin-usermember-registration');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.bcAdmin.userMember.bc-admin-usermember-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.bcAdmin.userMember.bc-admin-usermember-edit')->with(compact('users'));
    }
