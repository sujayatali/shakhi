...
class bcSsAdminController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.bcAdmin.ssAdmin.bc-admin-ssadmin-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.bcAdmin.ssAdmin.bc-admin-ssadmin-registration');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.bcAdmin.ssAdmin.bc-admin-ssadmin-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.bcAdmin.ssAdmin.bc-admin-ssadmin-edit')->with(compact('users'));
    }
