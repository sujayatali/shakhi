...
class bcShopUserController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.bcAdmin.shopKeeper.bc-admin-shopkeeper-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.bcAdmin.shopKeeper.bc-admin-shopkeeper-registration');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.bcAdmin.shopKeeper.bc-admin-shopkeeper-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.bcAdmin.shopKeeper.bc-admin-shopkeeper-edit')->with(compact('users'));
    }
