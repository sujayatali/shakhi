...
class subUserMemberController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.subAdmin.userMember.sub-admin-usermember-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.subAdmin.userMember.sub-admin-usermember-registration');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.subAdmin.userMember.sub-admin-usermember-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.subAdmin.userMember.sub-admin-usermember-edit')->with(compact('users'));
    }
