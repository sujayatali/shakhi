...
class subSsAdminController extends Controller
{
    /**
    ...
    public function index()
    {
        $users = DB::table('users')
                ...
                ->get()->where('meta_key','role')->where('meta_value','ss_admin');
        return view('webApps.subAdmin.ssAdmin.sub-admin-ssadmin-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.subAdmin.ssAdmin.sub-admin-ssadmin-registration');
    }
    ...
    public function store(Request $request)
    {
        ...
        update_user_meta($last_user_id, 'role', 'ss_admin');
        ...
        return redirect('/sub-admin/sub-ss-admin/create');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.subAdmin.ssAdmin.sub-admin-ssadmin-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.subAdmin.ssAdmin.sub-admin-ssadmin-edit')->with(compact('users'));
    }
