...
class subDcAdminController extends Controller
{
    /**
    ...
    public function index()
    {
        $users = DB::table('users')
                ...
                ->get()->where('meta_key','role')->where('meta_value','dc_admin');
        return view('webApps.subAdmin.dcAdmin.sub-admin-dcadmin-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.subAdmin.dcAdmin.sub-admin-dcadmin-registration');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/sub-admin/sub-dc-admin/create');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.subAdmin.dcAdmin.sub-admin-dcadmin-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.subAdmin.dcAdmin.sub-admin-dcadmin-edit')->with(compact('users'));
    }
