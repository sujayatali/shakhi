...
class subShopUserController extends Controller
{
    /**
    ...
    public function index()
    {
        $users = DB::table('users')
                ...
                ->get()->where('meta_key','role')->where('meta_value','shop_keeper');
        return view('webApps.subAdmin.shopKeeper.sub-admin-shopkeeper-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.subAdmin.shopKeeper.sub-admin-shopkeeper-registration');
    }
    ...
    public function store(Request $request)
    {
        ...
        update_user_meta($last_user_id, 'role', 'shop_keeper');
    ...
    {
        $users = User::find($id);
        return view('webApps.subAdmin.shopKeeper.sub-admin-shopkeeper-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.subAdmin.shopKeeper.sub-admin-shopkeeper-edit')->with(compact('users'));
    }
