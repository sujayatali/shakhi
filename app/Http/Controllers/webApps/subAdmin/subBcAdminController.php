...
namespace App\Http\Controllers\webApps\subAdmin;
...
class subBcAdminController extends Controller
{
    /**
    ...
    public function index()
    {
        $users = DB::table('users')
                ...
                ->get()->where('meta_key','role')->where('meta_value','bc_admin');
        return view('webApps.subAdmin.bcAdmin.sub-admin-bcadmin-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.subAdmin.bcAdmin.sub-admin-bcadmin-registration');
    }
    ...
    public function store(Request $request)
    {
        ...
        update_user_meta($last_user_id, 'role', 'dc_admin');
        ...
        return redirect('/sub-admin/sub-bc-admin/create');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.subAdmin.bcAdmin.sub-admin-bcadmin-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.subAdmin.bcAdmin.sub-admin-bcadmin-edit')->with(compact('users'));
    }
