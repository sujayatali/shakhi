...
class superUserMemberController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.superAdmin.userMember.super-admin-usermember-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.superAdmin.userMember.super-admin-usermember-registration');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/super-user-member/create');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.superAdmin.userMember.super-admin-userMember-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.superAdmin.userMember.super-admin-usermember-edit')->with(compact('users'));
    }
