...
class superSsAdminController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.superAdmin.ssAdmin.super-admin-ssadmin-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.superAdmin.ssAdmin.super-admin-ssadmin-registration');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/super-ss-admin/create');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.superAdmin.ssAdmin.super-admin-ssadmin-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.superAdmin.ssAdmin.super-admin-ssadmin-edit')->with(compact('users'));
    }
