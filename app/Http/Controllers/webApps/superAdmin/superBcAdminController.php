...
class superBcAdminController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.superAdmin.bcAdmin.super-admin-bcadmin-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.superAdmin.bcAdmin.super-admin-bcadmin-registration');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/super-bc-admin/create');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.superAdmin.bcAdmin.super-admin-bcadmin-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.superAdmin.bcAdmin.super-admin-bcadmin-edit')->with(compact('users'));
    }
