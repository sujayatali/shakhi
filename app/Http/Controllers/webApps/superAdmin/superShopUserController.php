...
class superShopUserController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.superAdmin.shopKeeper.super-admin-shopkeeper-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.superAdmin.shopKeeper.super-admin-shopkeeper-registration');
    }
