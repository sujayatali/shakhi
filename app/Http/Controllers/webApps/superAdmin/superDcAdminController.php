...
class superDcAdminController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.superAdmin.dcAdmin.super-admin-dcadmin-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.superAdmin.dcAdmin.super-admin-dcadmin-registration');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/super-dc-admin/create');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.superAdmin.dcAdmin.super-admin-dcadmin-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.superAdmin.dcAdmin.super-admin-dcadmin-edit')->with(compact('users'));
    }
