...
class dcSsAdminController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.dcAdmin.ssAdmin.dc-admin-ssadmin-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.dcAdmin.ssAdmin.dc-admin-ssadmin-registration');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.dcAdmin.ssAdmin.dc-admin-ssadmin-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.dcAdmin.ssAdmin.dc-admin-ssadmin-edit')->with(compact('users'));
    }
