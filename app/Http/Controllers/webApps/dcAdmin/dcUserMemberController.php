...
class dcUserMemberController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.dcAdmin.userMember.dc-admin-usermember-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.dcAdmin.userMember.dc-admin-usermember-registration');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.dcAdmin.userMember.dc-admin-usermember-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.dcAdmin.userMember.dc-admin-usermember-edit')->with(compact('users'));
    }
