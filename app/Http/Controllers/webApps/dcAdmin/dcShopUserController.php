...
class dcShopUserController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('webApps.dcAdmin.shopKeeper.dc-admin-shopkeeper-registration-view')->with(compact('users'));
    }
    ...
    {
        return view('webApps.dcAdmin.shopKeeper.dc-admin-shopkeeper-registration');
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.dcAdmin.shopKeeper.dc-admin-shopkeeper-view-single')->with(compact('users'));
    }
    ...
    {
        $users = User::find($id);
        return view('webApps.dcAdmin.shopKeeper.dc-admin-shopkeeper-edit')->with(compact('users'));
    }
