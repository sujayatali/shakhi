...
<head>
  ...
  <title>@yield('ss-admin-dashboard-title')</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/admin-dashboard" class="brand-link">
      ...
      <span class="brand-text font-weight-light">SS Admin</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/ss-admin/ss-user-member/create" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Register</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/ss-admin/ss-user-member" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View</p>
                </a>
              </li>
  ...
  @yield('ss-admin-dashboard-content')
...
@yield('ss-admin-dashboard-script')
