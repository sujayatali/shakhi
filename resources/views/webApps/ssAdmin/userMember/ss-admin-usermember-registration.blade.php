...
@section('ss-admin-dashboard-title','User Member Registration | Dashboard')
@section('ss-admin-dashboard-content')
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{ route('ss-user-member.store') }}"  id="product_form">
              {{csrf_field()}}
                  <div class="row">
  ...
  @php if(session('message-register')){ @endphp
    <button type="button" class="btn btn-default" data-toggle="modal" id="open-registration-popup" data-target="#modal-default">
    </button>
          ...
          <div class="modal-content">
            ...
            <ul class="list-group list-group-unbordered mb-3">
                    <li class="list-group-item">
                      <b>Name</b> <a class="float-right text-dark">{{$user['name']}}</a>
                    </li>
                    <li class="list-group-item">
                      <b>User Id</b> <a class="float-right text-dark">{{$user['email']}}</a>
                    </li>
                    <li class="list-group-item">
                      <b>Password</b> <a class="float-right text-dark">{{$user['password']}}</a>
                    </li>
            </ul>
            </div>
...
@section('ss-admin-dashboard-script')
@php if(session('message-register')){ @endphp
<script>
  jQuery('#open-registration-popup').click();
</script>
 @php } @endphp
@endsection