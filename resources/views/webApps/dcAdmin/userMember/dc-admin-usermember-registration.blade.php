...
@section('dc-admin-dashboard-title','User Member Registration | Dashboard')
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{ route('dc-user-member.store') }}"  id="product_form">
              {{csrf_field()}}
                  <div class="row">
