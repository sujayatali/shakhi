...
@section('dc-admin-dashboard-title','Shop Keeper Registration | Dashboard')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Shop Keeper Registration</h3>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{ route('sub-shop-keeper.store') }}"  id="product_form">
              {{csrf_field()}}
                  <div class="row">
