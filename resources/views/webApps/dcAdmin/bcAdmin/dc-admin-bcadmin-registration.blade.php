@extends('webApps.dcAdmin.dc-admin-dashboard')
@section('dc-admin-dashboard-title','BC Admin Registration | Dashboard')
@section('dc-admin-dashboard-content')
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{ route('dc-bc-admin.store') }}" id="product_form">
              <!-- <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{ route('sub-bc-admin.store') }}" id="product_form"> -->
              {{csrf_field()}}
                  <div class="row">
                  ...
                  <div class="col-sm-4"></div>
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="user_by_email" value="{{ session()->get('user')[0]->email }}" placeholder="Enter amount">
                      </div>
                    </div><!-- col-sm-4--->
                  </div>
