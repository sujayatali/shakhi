...
@section('bc-admin-dashboard-title','Shop Keeper Registration | Dashboard')
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{ route('bc-shop-keeper.store') }}"  id="product_form">
              {{csrf_field()}}
                  <div class="row">
