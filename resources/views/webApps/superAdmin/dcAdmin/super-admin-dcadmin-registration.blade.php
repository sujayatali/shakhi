...
@section('super-admin-dashboard-title','DC Admin Registration | Dashboard')
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{ route('super-dc-admin.store') }}"  id="product_form">
              {{csrf_field()}}
                  <div class="row">
