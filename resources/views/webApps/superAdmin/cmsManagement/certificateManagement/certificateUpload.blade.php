...
@section('super-admin-dashboard-title','Certificate | Dashboard')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Certificate Post</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Certificate Post</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Certificate Post</h3>
              </div>
             <!--  {{pre($errors->all())}} -->
              <!-- /.card-header -->
              <div class="card-body">
                <div class="container">
                    <section class="mt-5 text-center">
                      <form method="post" action="{{ route('certificate-manage.store') }}" enctype="multipart/form-data">
                        {{csrf_field()}}
                       <div class="bs-form-wrapper">  
                          <div class="input-group control-group input-wrapper">
                              ...
                              <input type="file" name="certificate" class="form-control" placeholder="Select Image">
