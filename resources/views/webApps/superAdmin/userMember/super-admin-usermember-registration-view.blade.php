...
@section('super-admin-dashboard-title','Uesr Member View | Dashboard')
                  ...
                  <tbody>
                      @foreach($users as $user)  
                        <tr align="center">
                          ...
                          <td><a href="/super-user-member/{{$user->user_id}}" target="_blank" title="View Profile"> <i class="fa fa-eye"></i></a></td>
                          <td><a href="{{url('/super-user-member/'.$user->user_id.'/edit')}}" target="_blank" title="Edit Profile"> <i class="fa fa-edit"></i></a></td>
                          <td>
                            <form action="{{ route('super-user-member.destroy', $user->user_id) }}" method="POST">
                              {{ method_field('DELETE') }}
                              {{ csrf_field() }}
