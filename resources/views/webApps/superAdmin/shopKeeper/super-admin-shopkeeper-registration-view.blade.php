...
@section('super-admin-dashboard-title','Shop Keeper View | Dashboard')
                  ...
                  <tbody>
                      @foreach($users as $user)  
                        <tr align="center">
                          ...
                          <td><a href="/super-shop-keeper/{{$user->user_id}}" target="_blank" title="View Profile"> <i class="fa fa-eye"></i></a></td>
                          <td><a href="{{url('/super-shop-keeper/'.$user->user_id.'/edit')}}" target="_blank" title="Edit Profile"> <i class="fa fa-edit"></i></a></td>
                          <td>
                            <form action="{{ route('super-shop-keeper.destroy', $user->user_id) }}" method="POST">
                              {{ method_field('DELETE') }}
                              {{ csrf_field() }}
